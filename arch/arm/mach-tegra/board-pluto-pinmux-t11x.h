...
static __initdata struct tegra_pingroup_config pluto_pinmux_common[] = {
	...
	/* I2S1 pinmux */
	DEFAULT_PINMUX(DAP2_DIN,      I2S1,       PULL_UP,   NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(GMI_AD13,      RSVD3,         PULL_UP,    NORMAL,   OUTPUT),
	...
	/* PWM1 pinmux */
	DEFAULT_PINMUX(GMI_AD9,       PWM1,        PULL_UP,    NORMAL,   OUTPUT),
	...
	/* UARTA pinmux */
	DEFAULT_PINMUX(KB_ROW10,      RSVD1,       PULL_UP,    NORMAL, INPUT),/*ZTE mod for POWER KEY*/
	...
	DEFAULT_PINMUX(GPIO_X1_AUD,   RSVD1,       NORMAL,    NORMAL,    OUTPUT),

	/* CEC pinmux */
	CEC_PINMUX(HDMI_CEC, SOC, NORMAL, NORMAL, INPUT, DISABLE, DISABLE),
	...
	DEFAULT_PINMUX(SPDIF_OUT,     SPDIF,       NORMAL,    NORMAL,   OUTPUT),
       ...
       /* CODEC */
      DEFAULT_PINMUX(GPIO_W3_AUD,    SPI6,    NORMAL,      NORMAL,    INPUT), //irq
      DEFAULT_PINMUX(KB_COL5,         KBC,     NORMAL,    NORMAL,   OUTPUT), //en
      DEFAULT_PINMUX(KB_ROW7,     KBC,      NORMAL,    NORMAL,    INPUT), //hp detect gpio irq
...
//	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO0, true, 0),
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH1, false, 1),/*ZTE: added by tong.weili for backlight pin 20130315*/
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH2, false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH4, false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH5, false, 1),/*ZTE: modified by tong.weili for LCD reset pin 20130315*/
