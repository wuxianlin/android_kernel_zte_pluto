...
//	DEFAULT_PINMUX(ULPI_DATA7,    ULPI,     NORMAL,      NORMAL,    OUTPUT),
	...
	DEFAULT_PINMUX(GMI_AD9,     GMI,      PULL_UP,      NORMAL,    OUTPUT),/*ZTE: added by tong.weili for backlight pin 20130315*/
	DEFAULT_PINMUX(GMI_AD10,    GMI,      PULL_DOWN,    NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GMI_AD12,    GMI,      PULL_UP,      NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GMI_AD13,    GMI,      NORMAL,    NORMAL,    OUTPUT),/*ZTE: modified by tong.weili for LCD reset pin 20130315*/
	...
	DEFAULT_PINMUX(KB_ROW4,     KBC,      PULL_UP,      NORMAL,    INPUT),
