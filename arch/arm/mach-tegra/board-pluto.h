...
#define modem_power_enb	TEGRA_GPIO_PP2
#define modem_usb3v3_enb	TEGRA_GPIO_PH2 
#define usb_port_ctrl0  TEGRA_GPIO_PA5
//#define usb_port_ctrl1  TEGRA_GPIO_PA4
//#define modem_power_key   TEGRA_GPIO_PD0  // NC
//#define modem_download_en TEGRA_GPIO_PH2
//#define modem_reset_en    TEGRA_GPIO_PD1  // NC

#define modem_dead        TEGRA_GPIO_PP1
#define MODEM_TO_AP_SLP         TEGRA_GPIO_PV0  
#define MODEM_TO_AP_WKUP        TEGRA_GPIO_PV1  
#define AP_TO_MODEM_SLP         TEGRA_GPIO_PP0  
#define AP_TO_MODEM_WKUP        TEGRA_GPIO_PP3  
/*-- cuijian add for modem driver 20121213 --*/
...
/* Audio-related GPIOs */
#define CODEC_CEN_PIN		TEGRA_GPIO_PQ5
...
#define TEGRA_GPIO_SPK_DC_EN_PIN	TEGRA_GPIO_PH4

#define TEGRA_SOC_OC_IRQ_BASE		TEGRA_NR_IRQS
#define TEGRA_SOC_OC_NUM_IRQ		TEGRA_SOC_OC_IRQ_MAX

#define TEGRA_GPIO_HARD_VERSION0   TEGRA_GPIO_PR0
#define TEGRA_GPIO_HARD_VERSION1   TEGRA_GPIO_PR1
#define TEGRA_GPIO_HARD_VERSION2   TEGRA_GPIO_PR2


#define TEGRA_GPIO_SPK_HEAD_MIC_SWITCH		TEGRA_GPIO_PX1
...
#define CAM2_POWER_DWN_GPIO		TEGRA_GPIO_PA2    //TEGRA_GPIO_PBB6
...
//ZTE: no use, TEGRA_GPIO_PO7 is for spi 
//#define MPU_GYRO_IRQ_GPIO	TEGRA_GPIO_PO7
#define MPU_GYRO_IRQ_GPIO	TEGRA_GPIO_PO1
...
#define MDM_COLDBOOT			TEGRA_GPIO_PO2
