...
/*ZTE:add by caixiaoguang 20130528 for usb id++*/
    max77665_read(muic->parent, MAX77665_I2C_SLAVE_MUIC,
			MAX77665_MUIC_REG_CONTROL1, &control1_reg);	
    control1_reg |= 0x80;
    max77665_write(muic->parent, MAX77665_I2C_SLAVE_MUIC,
			MAX77665_MUIC_REG_CONTROL1, control1_reg);
    max77665_read(muic->parent, MAX77665_I2C_SLAVE_MUIC,
			MAX77665_MUIC_REG_CONTROL1, &control1_reg);	
/*ZTE:add by caixiaoguang 20130528 for usb id--*/
