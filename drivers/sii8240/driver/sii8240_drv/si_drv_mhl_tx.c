...
void SiiMhlTxDeviceIsr (void)
{
    	...
    	{
	#if 0
		TXD_DEBUG_PRINT(("********* EXITING ISR *************\n"));
		TXD_DEBUG_PRINT(("Drv: INT1 Status = %02X\n", (int) SiiRegRead((REG_INTR1))));
		TXD_DEBUG_PRINT(("Drv: INT2 Status = %02X\n", (int) SiiRegRead((REG_INTR2))));
		TXD_DEBUG_PRINT(("Drv: INT3 Status = %02X\n", (int) SiiRegRead((REG_INTR3))));
		...
		TXD_DEBUG_PRINT(("Drv: REG_TPI_INTR_ST0 = %02X\n", (int) SiiRegRead(REG_TPI_INTR_ST0)));
		TXD_DEBUG_PRINT(("Drv: REG_TPI_INTR_ST0_ENABLE = %02X\n", (int) SiiRegRead(REG_TPI_INTR_ST0_ENABLE)));
	
		TXD_DEBUG_PRINT(("Drv: REG_CBUS_INT_0 = %02X\n", (int) SiiRegRead(REG_CBUS_INT_0 )));	
		TXD_DEBUG_PRINT(("Drv: REG_CBUS_INT_1: %02X\n", (int) SiiRegRead(REG_CBUS_INT_1)));
		TXD_DEBUG_PRINT(("Drv: REG_CBUS_INT_0_MASK = %02X\n", (int) SiiRegRead(REG_CBUS_INT_0_MASK )));	
		TXD_DEBUG_PRINT(("Drv: REG_CBUS_INT_1_MASK: %02X\n", (int) SiiRegRead(REG_CBUS_INT_1_MASK)));

		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR1_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR1_MASK)));
    		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR2_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR2_MASK)));
		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR3_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR3_MASK)));
    		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR4_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR4_MASK)));		
		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR5_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR5_MASK)));
    		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR7_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR7_MASK)));
		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR8_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR8_MASK)));
    		TXD_DEBUG_PRINT(("SiiRegRead(REG_INTR9_MASK) = %02X\n\n", (int)SiiRegRead(REG_INTR9_MASK)));

		TXD_DEBUG_PRINT(("Drv: A0 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00A0))));
		TXD_DEBUG_PRINT(("Drv: A1 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00A1))));
		TXD_DEBUG_PRINT(("Drv: A2 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00A2))));
		TXD_DEBUG_PRINT(("Drv: A3 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00A3))));
	
		TXD_DEBUG_PRINT(("Drv: B0 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00B0))));
		TXD_DEBUG_PRINT(("Drv: B1 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00B1))));
		TXD_DEBUG_PRINT(("Drv: B2 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00B2))));
		TXD_DEBUG_PRINT(("Drv: B3 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00B3))));
	
		TXD_DEBUG_PRINT(("Drv: E0 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00E0))));
		TXD_DEBUG_PRINT(("Drv: E1 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00E1))));
		TXD_DEBUG_PRINT(("Drv: E2 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00E2))));
		TXD_DEBUG_PRINT(("Drv: E3 STATUS Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00E3))));
	
		TXD_DEBUG_PRINT(("Drv: F0 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00F0))));
		TXD_DEBUG_PRINT(("Drv: F1 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00F1))));
		TXD_DEBUG_PRINT(("Drv: F2 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00F2))));
		TXD_DEBUG_PRINT(("Drv: F3 INT Set = %02X\n", (int) SiiRegRead((TX_PAGE_CBUS | 0x00F3))));
		TXD_DEBUG_PRINT(("********* END OF EXITING ISR *************\n"));
#endif
    		if (I2C_INACCESSIBLE == Int4Isr())
    		{
    			return; // don't do any more I2C traffic until the next interrupt.
...
#define SWITCH_AP_TO_MHL 2
#define SWITCH_MHL_TO_AP 0
extern int modem_usb_enable(int enable);
...
{
	modem_usb_enable(SWITCH_MHL_TO_AP);
			...
			*/
			...
			if (int4Status & BIT_INTR4_RGND_DETECTION)
			{
				...
				if (POWER_STATE_D0_MHL != fwPowerState)
				{
					if (RgndResultIsMhl())
					{
						modem_usb_enable(SWITCH_AP_TO_MHL);
