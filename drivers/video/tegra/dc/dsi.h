...
#define MIPI_T_HSPREPARE_NS_MIN(clk_ns)	(20 + 4 * (clk_ns))   //modify by liyibo for flash screen at 2013-11-13
...
/* ZTE_MODIFY : modify begin by liyibo for flash screen 2013-8-30 */
#if 0
#define T_HSPREPARE_NS_DEFAULT(clk_ns)	(65 + 5 * (clk_ns))
#else
#define T_HSPREPARE_NS_DEFAULT(clk_ns)	(27 + 5 * (clk_ns))
#endif
/* ZTE_MODIFY : modify end by liyibo for flash screen 2013-8-30 */
