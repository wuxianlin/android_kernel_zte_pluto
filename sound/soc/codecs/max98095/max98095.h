...
/* M98095_007_JACK_AUTO_STS */
	...
	#define M98095_IVID_IN           (1<<4)
	#define M98095_MCSW              (1<<1)
/* M98095_00F_HOST_CFG */
	#define M98095_SEG                      (1<<0)
	#define M98095_XTEN                     (1<<1)
	#define M98095_MDLLEN                   (1<<2)
	#define M98095_XTCLKEN                  (1<<3)
	#define M98095_DCRYPTEN                 (1<<4)

/* M98095_013_JACK_INT_EN */
       #define M98095_IDDONE                  (1<<7)
	#define M98095_IMCSW                   (1<<1)
	#define M98095_IKEYDET                    (1<<0)
...
/* M98095_02B_DAI1_CLOCK, M98095_035_DAI2_CLOCK, M98095_03F_DAI3_CLOCK */
	...
	#define M98095_DAI_BSEL_DIV8         (1<<3)
...
/* M98095_02E_DAI1_FILTERS, M98095_038_DAI2_FILTERS, M98095_042_DAI3_FILTERS */
	#define M98095_DAI_DHF                  (1<<3)
       #define M98095_DAI_FILTER_TYPE   (1<<7)

/*M98095_032_DAI2_CLKCFG_HI*/
    #define M98095_PLL2                             (1<<7)
       
/* M98095_045_DSP_CFG */
//ZTE: modify for hook detect 
//	#define M98095_DSPNORMAL                (5<<4)
       #define M98095_DSPNORMAL                (1<<6)
	#define M98095_JKSWTYP                     (1<<5)
	#define M98095_ADCDAI_MASK              (3<<6)
	#define M98095_ADCDAI_SHIFT             6

/* M98095_046_DAC_CTRL1 */
 	#define M98095_CHOPCLKNORMAL            (3<<0)

/* M98095_048_MIX_DAC_LR */
	#define M98095_DAI1L_TO_DACR            (1<<7)
	#define M98095_DAI1R_TO_DACR            (1<<6)
	#define M98095_DAI2M_TO_DACR            (1<<5)
	#define M98095_DAI3M_TO_DACR            (1<<4)
...
/* M98095_058_LVL_DAI1_PLAY, M98095_05A_LVL_DAI2_PLAY, M98095_05C_LVL_DAI3_PLAY */
	#define M98095_DAI_MUTE                 (1<<7)
	#define M98095_DAI_MUTE_MASK            (1<<7)

/* M98095_05D_LVL_ADC_L/M98095_05E_LVL_ADC_R */
	#define M98095_ADC_ATT        (0x0F)
...
/* M98095_091_PWR_EN_OUT */
	#define M98095_HPREN                    (1<<7)
	#define M98095_HPLEN                    (1<<6)
	#define M98095_HPEN                     ((1<<7)|(1<<6))
	#define M98095_SPREN                    (1<<5)
	#define M98095_SPLEN                    (1<<4)
	#define M98095_RECEN                    (1<<3)
	#define M98095_DAREN                    (1<<1)
	#define M98095_DALEN                    (1<<0)

/* M98095_092_PWR_EN_OUT */
	#define M98095_SPK_FIXEDSPECTRUM        (0<<4)
	#define M98095_SPK_SPREADSPECTRUM       (1<<4)

/* M98095_093_BIAS_CTRL */
	#define M98095_VMICBIAS1_MASK           (3<<0)
	#define M98095_VMICBIAS2_MASK           (3<<2)
	#define M98095_VMICBIAS1_2_2V           (0<<0)
	#define M98095_VMICBIAS2_2_2V           (0<<2)
	#define M98095_VMICBIAS1_2_4V           (1<<0)
	#define M98095_VMICBIAS2_2_4V           (1<<2)
	#define M98095_VMICBIAS1_2_6V           (2<<0)
	#define M98095_VMICBIAS2_2_6V           (2<<2)
	#define M98095_VMICBIAS1_2_8V           (3<<0)
	#define M98095_VMICBIAS2_2_8V           (3<<2)

/* M98095_096_DAC_POWER */
     #define M98095_FITHEN2                   (1<<4)
...
#define M98095_KEYEN				(1<<3)
#define M98095_PIN5EN                            (1<<2) 

/* Silicon revision number */
#define M98095_REVB                         0x40
#define M98095_REVC                         0x42

//ZTE: fixed VOLUME
#define M98095_ADC_ATT_VOLUME 0x03
/***************************************************************
 * Silicon revision build selection:
 * For version A or B, enter: M98095_REVB
 * For version C,      enter: M98095_REVC
 ***************************************************************/
#define M98095_SILICON_VERSION	M98095_REVC
...
extern int max98095_mic_detect(struct snd_soc_codec *codec, struct snd_soc_jack *jack,
		      int det, int shrt);
